...
export const portalInviteEmail = (params: {
  name: string
  tempPassword: string
  loginUrl: string
}) =>
  ...
  <div style="text-align: center; margin-bottom: 32px;">
    <h1 style="color: #ffffff; font-size: 30px; font-weight: 700; margin: 0 0 8px; text-align: center;">
      Welcome to The CJE Experience Portal
    </h1>
    <p style="color: rgba(255, 255, 255, 0.7); font-size: 16px; margin: 0; text-align: center;">
  ...
  <p style="color: #ffffff; font-size: 16px; line-height: 1.6; margin: 0 0 24px; text-align: left;">
    Hi ${params.name || 'there'},
  </p>

  <p style="color: rgba(255, 255, 255, 0.8); font-size: 14px; line-height: 1.6; margin: 0 0 24px; text-align: left;">
    Welcome to <span style="color: #81D8D0; font-weight: 600;">The CJE Experience Portal</span> —
    your space to view projects, access resources, and stay in sync with our team.
  </p>

  <div style="background-color: #0a0a0a; border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 8px; padding: 24px; margin-bottom: 32px;">
    <p style="color: #ffffff; font-size: 11px; letter-spacing: 2px; text-transform: uppercase; margin: 0 0 16px; font-weight: 600;">
      Your Portal Access
    </p>
    <p style="color: rgba(255, 255, 255, 0.9); font-size: 14px; margin: 0 0 4px;">
      <strong>Temporary Password:</strong>
    </p>
    <p style="color: #ffffff; font-size: 20px; font-weight: 700; letter-spacing: 1px; margin: 4px 0 0;">
      ${params.tempPassword}
    </p>
    <p style="color: rgba(255, 255, 255, 0.6); font-size: 12px; margin: 12px 0 0;">
      For security, you can update your password after logging in.
    </p>
  </div>
  ...
  <div style="text-align: center; margin-bottom: 24px;">
    <a
      ...
      style="display: inline-block; background-color: #ffffff; color: #0a0a0a; font-size: 16px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.2);"
    >
      Log In to Your Portal
    </a>
  </div>

  <p style="color: rgba(255, 255, 255, 0.7); font-size: 13px; line-height: 1.6; margin: 0; text-align: left;">
    If you weren't expecting this email, you can ignore it. Your access will remain secure.
  </p>
`)
